...
botao3 = tkinter.Button(janela, text="Vermelho", background=("#32CD32"), command=lambda: trocar_cor("#32CD32"))
botao3.pack(expand=True)

botao2 = tkinter.Button(janela, text="Vermelho", background=("#1E90FF"), command=lambda: trocar_cor("#1E90FF"))
